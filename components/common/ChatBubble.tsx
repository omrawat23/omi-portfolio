...
const initialMessages: Message[] = [
  {
    id: 1,
    text: "Hello! I'm Om's Portfolio Assistant. How can I help you?",
    sender: 'bot',
...
const ChatBubble: React.FC = () => {
  ...
  return (
    <ExpandableChat
      className="hover:cursor-pointer max-w-[calc(100vw-2rem)] sm:max-w-[calc(100vw-4rem)] md:max-w-md max-h-[95vh] mt-4 ml-4"
