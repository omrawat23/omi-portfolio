...
export const ContributionGraph = ({
  ...
  weekStart = 0,
  className,
  colors = ['#ebedf0', '#c6e48b', '#7bc96f', '#239a3b', '#196127'], // Default to GitHub light colors
  ...props
...
export const ContributionGraphBlock = ({
  ...
  const { blockSize, blockMargin, blockRadius, labelHeight, maxLevel, colors } =
  ...
  return (
    <rect
      ...
      style={{ fill: colors[activity.level] }}
      {...props}
    />
  );
};
...
export const ContributionGraphLegend = ({
  ...
  const { labels, maxLevel, blockSize, blockRadius, colors } = useContributionGraph();
